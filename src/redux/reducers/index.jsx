...
import {
  ...
  ADMIN_SUBMIT_VOTE_SUCCESS,
  GET_WINNERS_START,
  GET_WINNERS_SUCCESS,
  GET_WINNERS_FAIL,
  ADMIN_SUBMIT_VOTE_FAIL,
} from '../actions';
  ...
  switch (action.type) {
    ...
    case GET_SUBMISSIONS_SUCCESS || ADMIN_SUBMIT_VOTE_SUCCESS:
      return {
        ...
        // topThree: action.submissions.data.top3,
        hasAdminVoted: action.submissions.data.hasVoted,
      };
    ...
    case ADMIN_UNVOTE:
      return {
        ...
        votes: state.votes.filter(
          (each) => each.story_id !== action.payload.story_id
        ),
      };
